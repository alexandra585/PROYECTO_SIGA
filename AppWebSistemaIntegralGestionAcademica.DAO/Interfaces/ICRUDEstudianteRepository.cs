...
namespace AppWebSistemaIntegralGestionAcademicaSIGA.DAO.Interfaces
{
    public interface ICRUDEstudianteRepository
    {
        ...
        Task<List<UsuarioViewModel>> BuscarUsuarioDisponibleEstudiante(string? filtro); // listo usp
        Task<bool> ActualizarRolUsuarioEstudiante(int id, string rol); // listo usp
    }
}
