...
GO
/*-------------------------------------------------------------------------------------------------*/
IF EXISTS (SELECT * FROM sys.objects WHERE type = 'p' AND name = 'usp_BuscarUsuarioDisponibleEstudiante')
    DROP PROCEDURE usp_BuscarUsuarioDisponibleEstudiante
GO

CREATE PROCEDURE usp_BuscarUsuarioDisponibleEstudiante
    @filtro NVARCHAR(100) = NULL
AS
BEGIN
    SET NOCOUNT ON;
...
GO
/*-------------------------------------------------------------------------------------------------*/
IF EXISTS (SELECT * FROM sys.objects WHERE type = 'p' AND name = 'usp_ActualizarRolUsuarioEstudiante')
    DROP PROCEDURE usp_ActualizarRolUsuarioEstudiante
GO

CREATE PROCEDURE usp_ActualizarRolUsuarioEstudiante
    @id INT,
    @rol NVARCHAR(20)
AS
BEGIN
