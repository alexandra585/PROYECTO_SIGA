            ...
            if (ModelState.IsValid)
            {
                try
                {
                    if (esUsuarioExistente)
                    {
                        ...
                        bool resultado = await _crudApoderadoRepository.CreateApoderado(model.id, model);
                        ...
                        TempData["Error"] = "Error al registrar el apoderado.";
                        TempData["TipoMensaje"] = "error";
                    }
                    else
                    {
                        // =======================================
                        // MODO 2: Crear usuario nuevo + apoderado
                        // =======================================
